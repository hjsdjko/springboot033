...
public class YonghuController {
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if(yonghuService.selectCount(new EntityWrapper<YonghuEntity>().eq("chepaihao", yonghu.getChepaihao()))>0) {
    ...
    public R update(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if(yonghuService.selectCount(new EntityWrapper<YonghuEntity>().ne("id", yonghu.getId()).eq("chepaihao", yonghu.getChepaihao()))>0) {
            return R.error("车牌号已存在");
        }
